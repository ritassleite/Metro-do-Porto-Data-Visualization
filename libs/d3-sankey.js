...
function ascendingSourceBreadth(a, b) {
  return a.index - b.index; //ascendingBreadth(a.source, b.source) || a.index - b.index;
}

function ascendingTargetBreadth(a, b) {
  return a.index - b.index; //ascendingBreadth(a.target, b.target) || a.index - b.index;
}
...
function Sankey() {
  ...
  let dx = 240; // nodeWidth
  let dy = 90, py; // nodePadding
  let id = defaultId;
  let align = justify;
  let sort;
  let linkSort;
